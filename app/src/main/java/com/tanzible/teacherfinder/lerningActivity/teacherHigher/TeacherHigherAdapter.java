...
public class TeacherHigherAdapter extends RecyclerView.Adapter<TeacherHigherAdapter.ViewHolder>{

    List<TeacherHigherModal> modalList;

    public TeacherHigherAdapter(List<TeacherHigherModal> modalList) {
        ...
        private void setData(final String name, final String experience, final String priority, final String subject,final int position){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (position != 0) {
                        Intent intent = new Intent(itemView.getContext(), TeacherHigherDetailActivity.class);
