...
public class TeachingRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teaching_registration);
    ...
    private void setType() {
        ...
        if (mAuth.getCurrentUser() != null){
            startActivity(new Intent(getApplicationContext(), TeachingDashboard.class));
            finish();
        }
                ...
                mAuth.createUserWithEmailAndPassword(uemail,upassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            Toast.makeText(TeachingRegistration.this,"User Created",Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(TeachingRegistration.this, "Error !" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
