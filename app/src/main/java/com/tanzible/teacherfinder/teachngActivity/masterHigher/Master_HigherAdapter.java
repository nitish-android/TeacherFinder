...
public class Master_HigherAdapter extends RecyclerView.Adapter<Master_HigherAdapter.ViewHolder> {

    private List<Master_HigherModal> master_higherModals;

    public Master_HigherAdapter(List<Master_HigherModal> master_higherModals) {
        this.master_higherModals = master_higherModals;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String image = master_higherModals.get(position).getStudent_image();
        String name = master_higherModals.get(position).getName();
        String priority = master_higherModals.get(position).getPriority();
        String subject = master_higherModals.get(position).getSubject();
        String student_class = master_higherModals.get(position).getStudent_class();
    ...
    public int getItemCount() {
        return master_higherModals.size();
    }
